# ============================================================================
# Benchmark: DIV2K at 8 qubits (256x256)
# ============================================================================
# Train QFT, EntangledQFT, TEBD, and MERA on DIV2K downscaled to 256x256.
# MERA is included (m=8 is a power of 2).
#
# Usage:
#   julia --project=. run_div2k_8q.jl light
#   julia --project=. run_div2k_8q.jl moderate
# ============================================================================
...
println("=" ^ 80)
println("Benchmark: DIV2K 8-qubit | Preset: $preset_name")
